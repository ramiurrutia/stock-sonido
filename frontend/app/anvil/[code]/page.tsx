...
export default async function ItemPage({ params, }: { params: Promise<{ code: string }>; }) {
    ...
    return (
        <main className="flex flex-col items-center justify-center p-6 h-screen max-w-180">
            <BackButton />
            <NavBar />
            <div className="flex flex-col m-4 rounded-lg p-4 max-h-xl w-full bg-linear-to-tl from-zinc-900 to-zinc-800 ring ring-zinc-600">
                ...
                <div className="text-center border-b border-zinc-400/80 p-2 mb-1">
                    <h2 className="font-bold text-xl text-zinc-200">{data.name}</h2>
